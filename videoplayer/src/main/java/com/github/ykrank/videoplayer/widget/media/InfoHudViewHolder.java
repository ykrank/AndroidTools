package com.github.ykrank.videoplayer.widget.media;
...
public class InfoHudViewHolder {
    ...
    private Handler mHandler = new InfoHudHandler(this);

    private static final class InfoHudHandler extends Handler {
        private final WeakReference<InfoHudViewHolder> infoHudViewHolderWeakReference;

        private InfoHudHandler(InfoHudViewHolder infoHudViewHolder) {
            this.infoHudViewHolderWeakReference = new WeakReference<>(infoHudViewHolder);
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_UPDATE_HUD: {
                    InfoHudViewHolder holder = infoHudViewHolderWeakReference.get();
                    if (holder == null)
                        break;

                    IMediaPlayer mMediaPlayer = holder.mMediaPlayer;
                    if (mMediaPlayer == null)
                        break;
                    ...
                    switch (vdec) {
                        ...
                        case IjkMediaPlayer.FFP_PROPV_DECODER_MEDIACODEC:
                            ...
                            break;
                        default:
                            holder.setRowValue(R.string.vdec, "");
                            break;
                    }
